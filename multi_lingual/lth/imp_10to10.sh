...
# Calculate Scores
bash lth/score.sh $save_dir/0/ ${save_dir}_0 $path_2_data $lang_list $lang_pairs $1
...
do
    ...
    # Calculate Scores
    bash lth/score.sh $save_dir/$i/ ${save_dir}_$i $path_2_data $lang_list $lang_pairs $1
    # Delete Best Model to save storage
