...
lang_pairs=en-fr,en-cs,en-de,en-gu,en-ja,en-my,en-ro,en-ru,en-vi,en-zh,zh-en,vi-en,ru-en,ro-en,my-en,ja-en,gu-en,de-en,cs-en,fr-en  #a list language pairs to train multilingual models, e.g. "en-fr,en-cs,fr-en,cs-en"
