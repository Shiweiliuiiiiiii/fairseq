...
class Masking(object):
    ...
    def init(self, model, train_loader , device, mode='one_shot_gm', density=0.05, erk_power_scale=1.0, iteration=0):
    ...
    def gradual_oBERT_pruning(self, current_pruning_rate, cpu=False, iteration=0):
