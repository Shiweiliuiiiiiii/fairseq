...
roberta_large.plot(x_axis, robert_gm_after_csqa_noe,  '--*',   label='One-Shot LRR w/o E (After)',color='#00BFFF',linewidth=linewidth, markersize=markersize, )
...
# robert_gm_after_g2t_noe  = [76.49, 74.61, 71.33, 54.13, 19.57, 19.57, 19.57, 19.57, 19.57, 19.57]
