...
robert_random = [28.99, 20.23, 21.87, 21.29, 20.97, 20.07, 20.48, 20.31, 20.97, 20.72]
...
roberta_large.plot(x_axis, robert_random,  '-',   label='Random',color='purple',linewidth=3, markersize=markersize, )
