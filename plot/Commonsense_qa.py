...
roberta_large.plot(x_axis, robert_gm_before,  '-',   label='OMP Before FT',color='green',linewidth=3, markersize=markersize, )
roberta_large.plot(x_axis, robert_gm_after,  '-',   label='OMP After FT',color='cyan',linewidth=3, markersize=markersize, )
roberta_large.plot(x_axis, robert_random_before,  '-',   label='Random Before FT',color='purple',linewidth=3, markersize=markersize, )
roberta_large.plot(x_axis, robert_random_after,  '-',   label='Random After FT',color='yellow',linewidth=3, markersize=markersize, )
