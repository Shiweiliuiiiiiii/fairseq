...
roberta_large.plot(x_axis, robert_snip_csqa,  '-o',   label='SNIP (Before)',color='#00FF00',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, robert_lth_csqa,  '-o',   label='LTH (After)',color='orange',linewidth=linewidth, markersize=markersize, )

roberta_large.plot(x_axis, robert_snip_rigl_csqa,  '--o',   label='SNIP+RIGL (Before)',color='#00FF00',linewidth=linewidth, markersize=markersize )
...
roberta_large.plot(x_axis, robert_gmp_csqa,  '-o',   label='GMP (During)',color='magenta',linewidth=linewidth, markersize=markersize, )
...
roberta_large.plot(x_axis, [acc_imp_wino[0]]*10,  '-o', color='black',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, acc_imp_wino[1:],  '-o', color='orange',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, acc_omg_after_wino,  '-o', color='#00BFFF',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, acc_random_after_wino,  '-o', color='#0072BD',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, acc_gmp_wino,  '-o', color='magenta',linewidth=linewidth, markersize=markersize, )


roberta_large.plot(x_axis, acc_snip_wino,  '-o', color='#00FF00',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, acc_snip_rigl_wino,  '--o', color='#00FF00',linewidth=linewidth, markersize=markersize )
roberta_large.plot(x_axis, acc_random_wino,  '-o', color='brown',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, acc_random_rigl_wino,  '--o', color='brown',linewidth=linewidth, markersize=markersize)
roberta_large.plot(x_axis, acc_gm_wino,  '-o',  color='#bcbd22',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, acc_omp_rigl_wino,  '--o' ,color='#bcbd22',linewidth=linewidth, markersize=markersize )
...
# roberta_large.plot(x_axis, acc_test_omp_after_high,  '-o',   label='One-Shot LRR (After)',color='#00BFFF',linewidth=linewidth, markersize=markersize, )
...
roberta_large.plot(x_axis, acc_test_gmp_RACE,  '-o', color='magenta',linewidth=linewidth, markersize=markersize, )


roberta_large.plot(x_axis, acc_test_snip_RACE,  '-o', color='#00FF00',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, acc_test_snip_rigl_RACE,  '--o', color='#00FF00',linewidth=linewidth, markersize=markersize )
...
# roberta_large.plot(x_axis, acc_test_omp_after_high,  '-o',   label='One-Shot LRR (After)',color='#00BFFF',linewidth=linewidth, markersize=markersize, )
# roberta_large.plot(x_axis, acc_test_random_after_high,  '-o',   label='Random LRR (After)',color='#0072BD',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, acc_test_gmp_high_RACE,  '-o', color='magenta',linewidth=linewidth, markersize=markersize, )


roberta_large.plot(x_axis, acc_test_snip_high_RACE,  '-o', color='#00FF00',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, acc_test_snip_rigl_high_RACE,  '--o', color='#00FF00',linewidth=linewidth, markersize=markersize )
