...
roberta_large.plot(x_axis, np.array(csqa_sparsity_gm_036),  '-o',  label='OMP (Before)', color='red',linewidth=linewidth, markersize=markersize, )
...
plt.savefig('layerwise_sparsity_csqa.pdf')
plt.show()