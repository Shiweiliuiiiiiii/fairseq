...
omp_before_all_scores_2to2 = all_scores_2to2[3]
...
omp_before_task_scores_2to2 = np.array(task_scores_2to2[3])-1
omp_rigl_task_before_scores_2to2 = task_scores_2to2[4]
random_task_after_scores_2to2 = task_scores_2to2[5]
...
random_task_after_scores_5to5 = task_scores_5to5[5]
...
random_task_after_scores_10to1= task_scores_10to1[5]
...
random_task_after_scores_10to10 = task_scores_10to10[5]
...
roberta_large.plot(x_axis, [imp_task_scores_2to2[0]]*10,  '-o',   label='Dense model',color='black',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, imp_task_scores_2to2[1:],  '-o',   label='LTH (After)',color='orange',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, snip_task_scores_2to2,  '-o',   label='SNIP (Before)',color='#228B22',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, snip_rigl_before_task_scores_2to2,  '--o',   label='SNIP+RIGL (Before)',color='#228B22',linewidth=linewidth, markersize=markersize )
roberta_large.plot(x_axis, omp_after_task_scores_2to2,  '-o',   label='OMP (After)',color='#00BFFF',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, random_before_task_scores_2to2,  '-o',   label='Random (Before)',color='brown',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, random_task_after_scores_2to2,  '-o',   label='Random (After)',color='#0072BD',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, random_rigl_task_cores_2to2,  '--o',   label='Random+RIGL (Before)',color='brown',linewidth=linewidth, markersize=markersize)
roberta_large.plot(x_axis, gmp_task_scores_2to2,  '-o',   label='GMP (During)',color='#CD00CD',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, omp_before_task_scores_2to2,  '-o',   label='OMP (Before)' ,color='#bcbd22',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, omp_rigl_task_before_scores_2to2,  '--o',   label='OMP+RIGL (Before)',color='#bcbd22',linewidth=linewidth, markersize=markersize )


roberta_large.set_title('mBART on 2-to-2 Translation',fontsize=Titlesize)
...
roberta_large.plot(x_axis, [imp_task_scores_5to5[0]]*10,  '-o', color='black',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, imp_task_scores_5to5[1:],  '-o',  color='orange',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, snip_task_scores_5to5,  '-o',  color='#228B22',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, snip_rigl_before_task_scores_5to5,  '--o', color='#228B22',linewidth=linewidth, markersize=markersize )
roberta_large.plot(x_axis, omp_after_task_scores_5to5,  '-o',  color='#00BFFF',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, random_before_task_scores_5to5,  '-o',  color='brown',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, random_task_after_scores_5to5,  '-o', color='#0072BD',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, random_rigl_task_cores_5to5,  '--o',  color='brown',linewidth=linewidth, markersize=markersize)
roberta_large.plot(x_axis, gmp_task_scores_5to5,  '-o',  color='#CD00CD',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, omp_before_task_scores_5to5, '-o', color='#bcbd22',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, omp_rigl_task_before_scores_5to5, '--o', color='#bcbd22',linewidth=linewidth, markersize=markersize )


roberta_large.set_title('mBART on 5-to-5 Translation',fontsize=Titlesize)
roberta_large.axes.get_xaxis().set_visible(True)
roberta_large.set_ylabel(r'BLEU $\uparrow$', fontsize=Titlesize)
roberta_large.xaxis.set_ticks(x_axis)
roberta_large.set_xticklabels(np.array([0.2, 0.36, 0.488, 0.590, 0.672, 0.738, 0.791, 0.8325, 0.866, 0.893]), rotation=45, fontsize=10 )
...
roberta_large.plot(x_axis, [imp_task_scores_10to10[0]]*10,  '-o',  color='black',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, imp_task_scores_10to10[1:],  '-o', color='orange',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, snip_task_scores_10to10,  '-o',  color='#228B22',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, snip_rigl_before_task_scores_10to10,  '--o',  color='#228B22',linewidth=linewidth, markersize=markersize )
roberta_large.plot(x_axis, omp_after_task_scores_10to10,  '-o',  color='#00BFFF',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, random_before_task_scores_10to10,  '-o',  color='brown',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, random_task_after_scores_10to10,  '-o',  color='#0072BD',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, random_rigl_task_cores_10to10,  '--o',   color='brown',linewidth=linewidth, markersize=markersize)
roberta_large.plot(x_axis, gmp_task_scores_10to10,  '-o',  color='#CD00CD',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, omp_before_task_scores_10to10,  '-o',   color='#bcbd22',linewidth=linewidth, markersize=markersize, )
roberta_large.plot(x_axis, omp_rigl_task_before_scores_10to10,  '--o', color='#bcbd22',linewidth=linewidth, markersize=markersize )


roberta_large.set_title('mBART on 10-to-10 Translation',fontsize=Titlesize)
roberta_large.axes.get_xaxis().set_visible(True)
roberta_large.set_ylabel(r'BLEU $\uparrow$', fontsize=Titlesize)
roberta_large.xaxis.set_ticks(x_axis)
roberta_large.set_xticklabels(np.array([0.2, 0.36, 0.488, 0.590, 0.672, 0.738, 0.791, 0.8325, 0.866, 0.893]), rotation=45, fontsize=10 )
...
# roberta_large = fig.add_subplot(1,3,4)
# roberta_large.plot(x_axis, [imp_task_scores_10to1[0]]*10,  '-o', color='black',linewidth=linewidth, markersize=markersize, )
# roberta_large.plot(x_axis, imp_task_scores_10to1[1:],  '-o',   color='orange',linewidth=linewidth, markersize=markersize, )
# roberta_large.plot(x_axis, snip_task_scores_10to1,  '-o',  color='#228B22',linewidth=linewidth, markersize=markersize, )
# roberta_large.plot(x_axis, snip_rigl_before_task_scores_10to1,  '--o',  color='#228B22',linewidth=linewidth, markersize=markersize )
# roberta_large.plot(x_axis, omp_after_task_scores_10to1,  '-o', color='#00BFFF',linewidth=linewidth, markersize=markersize, )
# roberta_large.plot(x_axis, random_before_task_scores_10to1,  '-o',  color='brown',linewidth=linewidth, markersize=markersize, )
# roberta_large.plot(x_axis, random_task_after_scores_10to1,  '-o',  color='#0072BD',linewidth=linewidth, markersize=markersize, )
# roberta_large.plot(x_axis, random_rigl_task_cores_10to1,  '--o',   color='brown',linewidth=linewidth, markersize=markersize)
# roberta_large.plot(x_axis, gmp_task_scores_10to1,  '-o',   color='#CD00CD',linewidth=linewidth, markersize=markersize, )
# roberta_large.plot(x_axis, omp_before_task_scores_10to1,  '-o',  color='#bcbd22',linewidth=linewidth, markersize=markersize, )
# roberta_large.plot(x_axis, omp_rigl_task_before_scores_10to1,  '--o',  color='#bcbd22',linewidth=linewidth, markersize=markersize )
#
#
# roberta_large.set_title('mBART on 10-to-1 Translation',fontsize=Titlesize)
# roberta_large.axes.get_xaxis().set_visible(True)
# roberta_large.set_ylabel(r'BLEU $\uparrow$', fontsize=Titlesize)
# roberta_large.xaxis.set_ticks(x_axis)
# roberta_large.set_xticklabels(np.array([0.2, 0.36, 0.488, 0.590, 0.672, 0.738, 0.791, 0.8325, 0.866, 0.893]), rotation=45, fontsize=10 )
...
plt.savefig('multilingual_test_local.pdf')
plt.show()
